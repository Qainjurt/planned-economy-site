document.addEventListener('DOMContentLoaded', function() {
    ...
    const getFontSize = (baseSize) => window.innerWidth < 768 ? baseSize * 0.8 : baseSize;
        ...
        options: {
            ...
            scales: {
                y: {
                    ...
                    ticks: { font: { size: getFontSize(10) } }
                },
                x: {
                    title: {
                        display: true,
            ...
            plugins: {
                legend: {
                    labels: { font: { size: getFontSize(12) } }
                }
            }
        }
    });
    ...
    // Опцияны таңдағанда active классын қосу
